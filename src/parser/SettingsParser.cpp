...
bool SettingsParser::isMethodAllowedOnRoute(unsigned int server_idx,
  ...
  std::vector<std::string> allowed_methods = this->global.getServers()[server_idx]
                                                 .getRoutes()[route_idx]
                                                 .getAllowedMethods();
...
bool SettingsParser::getRouteAutoIndex(unsigned int server_idx,
  ...
  return this->global.getServers()[server_idx].getRoutes()[route_idx].getAutoIndex();
}
...
std::string SettingsParser::getRouteUploadDir(unsigned int server_idx,
  ...
  return this->global.getServers()[server_idx].getRoutes()[route_idx].getUploadDir();
}
